...
# 调试输出函数
def debug_output(rename_operations, stat_operations, data_amounts):
...
# 读取日志文件
log_file_path = r'C:\Users\chenz\Desktop\sr\sr_project1_data\the_entire_process\rename_data_size.txt'
...
# 调试输出
debug_output(rename_operations, stat_operations, data_amounts)
